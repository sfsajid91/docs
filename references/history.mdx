...
```
https://app.scrapeautomate.com/api/requests?api_key=<exampleToken>
```
...
```
https://app.scrapeautomate.com/api/requests?api_key=<exampleToken>&page=2
```
...
```
https://app.scrapeautomate.com/api/requests?api_key=<exampleToken>&page=1&limit=100
```
...
```
https://app.scrapeautomate.com/api/requests/${requestId}?api_key=<exampleToken>
```
