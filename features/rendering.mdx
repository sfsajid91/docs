...
- [**Screenshot**](/feature/output#full-page-screenshot): Allows you to take a screenshot of the rendered page.
- [**Blocking Resources**](/feature/blocking): Blocks specific resources from loading. e.g. images, scripts, ads, cookie banners, etc.
